...
export default function TextToSpeechButton({
  ...
  return (
    <button
      className={clsx(
        className,
        'inline-flex justify-between items-center border border-transparent font-medium rounded-md shadow-sm text-white bg-brand-mint hover:bg-brand-mint-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-mint-dark',
        {
